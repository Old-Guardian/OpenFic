...
const TOOL_RUNNING_STATUS: Record<string, AgentRunningStatus> = {
  ...
  search_characters: AGENT_RUNNING_STATUS.characterRead,
  read_characters: AGENT_RUNNING_STATUS.characterRead,
  ...
  query_character_relationships: AGENT_RUNNING_STATUS.characterRead,
  create_character_relationship: AGENT_RUNNING_STATUS.characterWrite,
  edit_character_relationship: AGENT_RUNNING_STATUS.characterWrite,
  delete_character_relationship: AGENT_RUNNING_STATUS.characterWrite,
  list_world_entries: AGENT_RUNNING_STATUS.worldRead,
  read_world_entry: AGENT_RUNNING_STATUS.worldRead,
  search_world_entries: AGENT_RUNNING_STATUS.worldRead,
  read_world_entries: AGENT_RUNNING_STATUS.worldRead,
