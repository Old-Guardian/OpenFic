...
_PERMISSION_METADATA_BY_TOOL_NAME = {
    ...
    "create_character_relationship": ToolPermissionMetadata("create_character_relationship", "ask"),
    ...
    "delete_character_relationship": ToolPermissionMetadata("delete_character_relationship", "ask"),
    ...
    "edit_character_relationship": ToolPermissionMetadata("edit_character_relationship", "ask"),
    ...
    "list_file": ToolPermissionMetadata("list_file", "allow"),
    ...
    "read_file": ToolPermissionMetadata("read_file", "allow"),
    ...
    "read_characters": ToolPermissionMetadata("read_characters", "allow"),
    "query_character_relationships": ToolPermissionMetadata("query_character_relationships", "allow"),
    "read_note": ToolPermissionMetadata("read_note", "allow"),
    "read_range_summaries": ToolPermissionMetadata("read_range_summaries", "allow"),
    "read_world_entries": ToolPermissionMetadata("read_world_entries", "allow"),
    ...
    "search_characters": ToolPermissionMetadata("search_characters", "allow"),
    "search_world_entries": ToolPermissionMetadata("search_world_entries", "allow"),
